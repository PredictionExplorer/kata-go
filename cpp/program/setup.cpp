...
vector<SearchParams> Setup::loadParams(
  ...
  for(int i = 0; i<numBots; i++) {
    ...
    if(cfg.contains("scoreScale"+idxStr)) params.scoreScale = cfg.getDouble("scoreScale"+idxStr, 5.0, 1000.0);
    else if(cfg.contains("scoreScale"))   params.scoreScale = cfg.getDouble("scoreScale",        5.0, 1000.0);
    else                                  params.scoreScale = 20.0;
    if(cfg.contains("winWeight"+idxStr)) params.winWeight = cfg.getDouble("winWeight"+idxStr, 0.0, 100.0);
    else if(cfg.contains("winWeight"))   params.winWeight = cfg.getDouble("winWeight",        0.0, 100.0);
    else                                 params.winWeight = 2.0;
